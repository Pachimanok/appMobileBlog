...
const routes = [
    ...
    {
        path: 'post/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_post_post_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./post/post.module */ 2076)).then(m => m.PostPageModule)
    },
    {
        path: 'posts',
